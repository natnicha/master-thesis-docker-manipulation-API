...
All APIs in this repository aim to manage pods running under a service in Kubernetes. This repository is implemented to facilitate our agent in Reinforcement Learning (RL) from [RL-Based Autoscaler Repository](https://github.com/natnicha/master-thesis-auto-scaler). These APIs are implemented by [Python](https://www.python.org/), using [Docker SDK](https://docs.docker.com/reference/api/engine/sdk/) and [Kubernetes Client](https://kubernetes.io/docs/reference/using-api/client-libraries/). 
